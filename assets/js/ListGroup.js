...
function efetuarFiltroPorAno(ano) {
    ...
    $('section[id*=totalContent]').attr('style', 'display:none;');
...
function onSuccess(result) {
    ...
    for (i = 0; i < result.d.length; i++) {
        if (!(typeof result.d[i].Titulo === "undefined")) {
            var corpoHtmlBase = '<div class="accordion-item" data-aos="fade-up"> <h2 class="accordion-header" id="heading-"> <button class="accordionList accordion-button collapsed" type="button" data-bs-toggle="collapse"  aria-expanded="false"   > #TituloCanal </button> </h2> <div id="collapse-" class="accordion-collapse collapse"  data-bs-parent="#accCotacoesDocumentos"> <div  class="accordion-body"> <ul class="list-downloads"> #RecebeConteudos </ul> </div> </div> </div>'
